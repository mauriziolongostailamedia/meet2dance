...
define('OW_URL_HOME', 'http://meet2dance.org/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'dancemee_oxwal16');
define('OW_DB_PASSWORD', '@2SyY!2p39');
define('OW_DB_NAME', 'dancemee_oxwal16');
...
define('OW_PASSWORD_SALT', '57f3f1d3650b8');
