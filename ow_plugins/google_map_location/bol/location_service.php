...
final class GOOGLELOCATION_BOL_LocationService
{
    ...
    public function getNewCoordinates( $latitude, $longitude, $bearing, $distance )
    {
        ...
        $latRation = 69;
        $lonRation = abs(cos(deg2rad($latitude))*69);
        ...
        {
            $latRation = $latRation / 1.8;
            $lonRation = $lonRation / 1.8;
            $d = $d/1.8;
        }
        ...
        $new_latitude = $latitude + $d / $latRation * $latK;
        $new_longitude = $longitude + $d / $lonRation * $lonK;
