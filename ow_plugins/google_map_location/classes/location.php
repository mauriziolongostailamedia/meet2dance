...
class GOOGLELOCATION_CLASS_Location extends InvitationFormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        OW::getDocument()->addOnloadScript(' $( document ).ready( function(){ window.googlemap_location = new window.OW_GoogleMapLocation( ' . json_encode($this->getName()) . ', ' . json_encode($this->getId()) . ', ' . json_encode($this->getName() . '_map') . ' );
        ...
        $html .= '<div id="' . $this->getName() . '_map" style="margin-top:10px;width:90%;height:200px;display:none;position:relative;"></div>';
