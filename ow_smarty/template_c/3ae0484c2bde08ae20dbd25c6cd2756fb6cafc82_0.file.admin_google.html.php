<?php
/* Smarty version 3.1.29, created on 2016-10-16 12:32:08
  from "/home/dancemee/public_html/ow_plugins/contact_importer/views/controllers/admin_google.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_580357283358d8_36921341',
  'file_dependency' => 
  array (
    '3ae0484c2bde08ae20dbd25c6cd2756fb6cafc82' => 
    array (
      0 => '/home/dancemee/public_html/ow_plugins/contact_importer/views/controllers/admin_google.html',
      1 => 1469551372,
      2 => 'file',
    ),
  ),
...
function content_580357283358d8_36921341 ($_smarty_tpl) {
...
<?php $_smarty_tpl->smarty->_cache['tag_stack'][] = array('form', array('name'=>"google_settings")); $_block_repeat=true; echo smarty_block_form(array('name'=>"google_settings"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

    <table class="ow_table_1 ow_form">
        <tr class="ow_tr_first">
            <th class="ow_name ow_txtleft" colspan="3">
                <span class="ow_section_icon ow_ic_script"><?php echo smarty_function_text(array('key'=>'contactimporter+google_settings_heading'),$_smarty_tpl);?>
</span>
            </th>
        </tr>
        <tr class="<?php echo smarty_function_cycle(array('name'=>"install",'values'=>"ow_alt1,ow_alt2"),$_smarty_tpl);?>
">
            <td class="ow_label"><?php echo smarty_function_label(array('name'=>"clientId"),$_smarty_tpl);?>
</td>
...
"><?php echo smarty_function_text(array('key'=>"contactimporter+facebook_how_to_config"),$_smarty_tpl);?>
        ...
        <tr class="<?php echo smarty_function_cycle(array('name'=>"install",'values'=>"ow_alt1,ow_alt2"),$_smarty_tpl);?>
 ow_tr_last">
            <td class="ow_label"><?php echo smarty_function_label(array('name'=>"clientSecret"),$_smarty_tpl);?>
</td>
            <td class="ow_value"><?php echo smarty_function_input(array('name'=>"clientSecret"),$_smarty_tpl);?>
 <?php echo smarty_function_error(array('name'=>"clientSecret"),$_smarty_tpl);?>
</td>
            <td class="ow_desc"></td>
        </tr>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_form(array('name'=>"google_settings"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_cache['tag_stack']);
}
}
